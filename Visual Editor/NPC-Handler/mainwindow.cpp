...
void config_theme_for_this_application(){
    ...
    ui_stylesheet_general = "QMenu::item:selected{background-color:" + primary_current  + ";color:" + text_color_current + ";}QMenu::item{background-color:" + background_current + ";color:" + primary_current + ";}QMenu::item:disabled{background-color:" + background_current + ";color: #ddd" + "}QWidget{background-color:" +  background_current + "; border-top-left-radius: 0px; border-top-right-radius: 0px;}QWidget{color:" + primary_current + " ;}";
